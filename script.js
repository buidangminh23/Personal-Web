document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        vi: {
            ...
            "exp2-date": "04/2026",
            "exp2-title": "Study Web",
            "exp2-company": "Full-Stack / Swinburne Learning Space",
            "exp2-desc": "Xây dựng không gian tự học và quản lý môn học của Swinburne, tích hợp hệ thống lộ trình học tập, tài liệu học và giao diện trực quan hỗ trợ sinh viên.",
            "exp3-date": "03/2026",
            "exp3-title": "Minh Stark Agent OS",
            "exp3-company": "AI System / Flask / Local Agent Automation",
            "exp3-desc": "Thiết kế hệ điều hành AI agent chạy local với tính năng AutoPilot tự phân tích, lập lịch học, theo dõi deadline và tự động thực thi các task thông minh.",
            "exp4-date": "01/2026",
            "exp4-title": "GEMERA Bot & AI Dashboard",
            "exp4-company": "System / Telegram Integration / Channel Analytics",
            "exp4-desc": "Phát triển bot Telegram quét và đăng tin tự động tích hợp AI Vision để loại bỏ trùng lặp, đi kèm dashboard phân tích số liệu kênh theo thời gian thực.",
        ...
        en: {
            ...
            "exp2-title": "Study Web",
            "exp2-company": "Full-Stack / Swinburne Learning Space",
            "exp2-desc": "Developed an online self-study space for Swinburne students, incorporating learning roadmaps, course resources, and an intuitive UI to manage study progress.",
            "exp3-date": "03/2026",
            "exp3-title": "Minh Stark Agent OS",
            "exp3-company": "AI System / Flask / Local Agent Automation",
            "exp3-desc": "Designed a local AI agent operating system equipped with AutoPilot to analyze tasks, schedule classes, track deadlines, and execute automated actions.",
            "exp4-date": "01/2026",
            "exp4-title": "GEMERA Bot & AI Dashboard",
            "exp4-company": "System / Telegram Integration / Channel Analytics",
            "exp4-desc": "Built an automated Telegram channel bot with AI Vision deduplication and a real-time dashboard displaying key growth and content metrics.",
